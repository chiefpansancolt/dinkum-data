...
| [foragables](src/modules/resources/foragables.md) | `foragables()` | 42    | Wild-foraged plants and items         |
...
| [equipment](src/modules/gear-and-equipment/equipment.md) | `equipment()` | 62    | Wearable and placeable equipment    |
| [tools](src/modules/gear-and-equipment/tools.md)         | `tools()`     | 89    | Gathering and combat tools          |
| [vehicles](src/modules/gear-and-equipment/vehicles.md)   | `vehicles()`  | 27    | Gliders and other rideable vehicles |
...
Items confirmed to exist in-game (via official patch notes) but not yet added here because the wiki
has no page for them yet to source their data from. Add these once a wiki page appears:

- **Switch Railway Track** — a train-track switch unlocked with the Train Licence, from the 1st
  Anniversary Update ("The Great Bite").
