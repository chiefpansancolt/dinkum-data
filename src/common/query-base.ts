/**
 * Abstract base class providing the standard terminal methods shared by all query builders.
...
export abstract class QueryBase<T extends { id: string; name: string }> {
  ...
  /** Filter to items whose name contains the given text (case-insensitive). */
